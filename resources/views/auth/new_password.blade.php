...
<html lang="en">
   <head>
      ...
      <title>New-password | Softech MicroFinance</title>
      <!-- Favicon -->
                              ...
                              <form class="mt-4"  action="{{ route('password.store') }}" method="POST">>
                                @csrf
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input name="email" type="email" class="form-control mb-0" id="exampleInputEmail1"  value="{{ old('email',$request->email)}}">
                                  </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="password" class="form-control mb-0" id="confirmPassword" name="password_confirmation">
                                    </div>
